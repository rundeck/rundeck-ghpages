---
layout: news
title: "Rundeck 2.6.4 is now available"
categories:
  - news
comments: true
...
[Download Rundeck 2.6.4 now](http://rundeck.org/downloads.html)


A copy of the [release notes](https://github.com/rundeck/rundeck/blob/v2.6.4/RELEASE.md) can be found below:
