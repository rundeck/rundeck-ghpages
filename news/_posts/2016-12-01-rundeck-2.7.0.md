---
layout: news
title: "Rundeck 2.7.0 is now available"
categories:
  - news
comments: true
author: Rundeck Project
published: true
news_rd_version: 2.7.0
---


[Download Rundeck 2.7.0 now](http://rundeck.org/downloads.html)


A copy of the [release notes](https://github.com/rundeck/rundeck/blob/v2.7.0/RELEASE.md) can be found below:
