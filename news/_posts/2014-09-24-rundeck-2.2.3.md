---
layout: news
title: "Rundeck 2.2.3 is now available"
categories:
  - news
comments: true
...
[Download Rundeck 2.2.3 now](http://rundeck.org/downloads.html)

A copy of the [release notes](https://github.com/rundeck/rundeck/blob/v2.2.3/RELEASE.md) can be found below:

Note: Rundeck 2.2.3 fixes several small issues with the previous 2.2.2 release.
