---
layout: news
title: "Rundeck 2.6.6 is now available"
categories:
  - news
comments: true
...
(**Note:** 2.6.6 corrects some missing changes in 2.6.5 that were in the release notes but not the build.)

[Download Rundeck 2.6.6 now](http://rundeck.org/downloads.html)


A copy of the [release notes](https://github.com/rundeck/rundeck/blob/v2.6.6/RELEASE.md) can be found below:
