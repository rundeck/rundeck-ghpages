---
layout: news
title: "Rundeck 2.8.4 is now available"
categories:
  - news
comments: true
author: Rundeck Project
published: true
news_rd_version: 2.8.4
---


[Download Rundeck 2.8.4 now](http://rundeck.org/downloads.html)


A copy of the [release notes](https://github.com/rundeck/rundeck/blob/v2.8.4/RELEASE.md) can be found below:
