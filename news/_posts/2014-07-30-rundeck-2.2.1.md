---
layout: news
title: "Rundeck 2.2.1 is now available"
categories:
  - news
comments: true
...
[Download Rundeck 2.2.1 now](http://rundeck.org/downloads.html)

This is primarily a bugfix release following the [2.2.0 release](https://github.com/rundeck/rundeck/blob/v2.2.0/RELEASE.md).

A copy of the [release notes](https://github.com/rundeck/rundeck/blob/v2.2.1/RELEASE.md) can be found below:
